...
def get_email_credentials():
    login_credentials_file_path = os.path.join(os.path.dirname(os.getcwd()), 'ExternalResources/AS_Login_Credentials.yaml')
...
def get_mailing_list() -> dict:
    mailing_list_file_path = os.path.join(os.path.dirname(__file__), 'Mailing_List.yaml')
    mailing_list = dict()
